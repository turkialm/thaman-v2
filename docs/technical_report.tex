...
\begin{titlepage}
    ...
    \begin{flushleft}
        ...
        {\small Generated: 2026-05-29 --- NYC Stack v22 · Riyadh Stack v12}
    \end{flushleft}
\end{titlepage}
...
\begin{table}[H]
  ...
  \begin{tabular}{lrl}
    ...
    Type & MedAPE & Notes \\
    \midrule
    Apartment (شقة)  & 12.83\% & Best-performing \\
    Villa (فيلا)     & 12.39\% & Best absolute \\
    Plot (قطعة أرض)  & 20.82\% & Hardest; land speculation \\
    Building (عمارة) & 18.61\% & \\
    \bottomrule
  \end{tabular}
\end{table}
