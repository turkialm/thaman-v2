...
function setCityMode(mode) {
  ...
  ['riyadhResults','riyadhShapCard','riyadhSpatialCard',
   'resultCard','shapCard','spatialCard','marketCard'].forEach(id => {
...
function copyRiyadhResults() {
  ...
  const text = [
    ...
    '',
    `Generated by THAMAN · AI-Powered Property Valuation`,
    `R² 0.8014 · MedAPE 15.59% · Riyadh Stack v12 · 7,261 Records`,
  ].filter(l => l !== null && l !== undefined).join('\n').replace(/\n{3,}/g, '\n\n');
