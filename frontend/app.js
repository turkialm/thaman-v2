...
function renderResults(data) {
  ...
  if (modelTagEl && data.model) {
    modelTagEl.textContent = data.model.includes('v5') ? 'Stack v5 · 4-Model' : data.model.includes('Stack') ? 'Stack v4 · XGB+LGB+CAT' : data.model;
  }
...
function copyResults() {
  ...
  const text = [
    ...
    `R² 0.658 · MedAPE 20.34% · 185K NYC sales 2022–2026`,
...
const TR = {
  en: {
    ...
    disclaimer:     'Predictions are based on NYC property sales 2022–2026. Model accuracy: median error ±20.34%.',
  ...
  ar: {
    ...
    disclaimer:     'التوقعات مبنية على مبيعات العقارات في مدينة نيويورك 2022–2026. دقة النموذج: متوسط الخطأ ±20.34٪.',
