"""
THAMAN Riyadh Model — Stack Training v4
=========================================
...
BASE_FEATURES = [
    ...
    "city_quarter_mean",
    "bayut_asking_psqm",
    # ── Sprint 3 — structural proxies (area + age only, NO psqm — avoids temporal leakage) ─
...
print("\n" + "=" * 60)
print("THAMAN Riyadh v4 — Training complete")
