...
print("=" * 65)
print("  THAMAN Stack v3 — XGBoost + LightGBM + CatBoost + Ridge + QoL v3")
print("=" * 65)
...
# ── 1. Load data ───────────────────────────────────────────────────
print("\n[1/8] Loading features_v3.csv …")
df = pd.read_csv(os.path.join(PROC, "features_v3.csv"))
...
# ── Summary ───────────────────────────────────────────────────────
print("\n" + "=" * 65)
print("  THAMAN Stack v3 — Complete")
print("=" * 65)
