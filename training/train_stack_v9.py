"""
THAMAN Stack v9 — train_stack_v9.py
=====================================
Key improvements over v8:
  • Same v6 feature set (93 features, raw NTA/ZIP encoding — no interactions)
  • 10-fold GroupKFold OOF (vs 5-fold) — more stable meta-learner calibration
  • 5000 rounds + patience=400 for XGB / LGB — deeper convergence
  • CatBoost 3000 iterations + patience=400

Expected gain vs v8: R² 0.635 → ~0.648–0.652, MedAPE 20.94% → ~20.0–20.2%

Run:
  cd /Users/totam/Desktop/new_try
  python training/train_stack_v9.py
"""
...
print("=" * 70)
print("  THAMAN Stack v9 — 10-Fold OOF + 5000 Rounds + Raw NTA Encoding")
print("=" * 70)
...
meta.update({
    ...
    "stack": {
        ...
        "r2_improvement":     round(r2_stk - 0.6350, 4),
        "medape_improvement": round(20.94 - mp_stk, 2),
    },
})
...
print("\n" + "="*70)
print("  THAMAN Stack v9 — Complete")
print("="*70)
...
for nm, r, m, mp_ in [("XGB-A",r2_xa,mae_xa,mp_xa),("XGB-B",r2_xb,mae_xb,mp_xb),
                       ...
                       ("Stack v9",r2_stk,mae_stk,mp_stk)]:
    print(f"  {nm:<24}  {r:>7.4f}  ${m:>13,.0f}  {mp_:>8.2f}%")
print(f"\n  vs v8: ΔR²={r2_stk-0.6350:+.4f}  ΔMedAPE={20.94-mp_stk:+.2f}pp")
