"""
THAMAN Riyadh Model — Stack Training v3
=========================================
Sprint 2 improvements over v2 (per-type OOF encodings EXCLUDED — too noisy with GroupKFold):
  1. Per-type look-back features: district_villa_lookback_mean, district_plot_lookback_mean
  2. Type × spatial interactions: apt×metro, apt×commercial, villa×park,
     villa×school, plot×intersections
  3. XGB min_child_weight tightened 5→7
"""
...
BASE_FEATURES = [
    ...
    "city_quarter_mean",
    "bayut_asking_psqm",
    # ── Sprint 2 — per-type look-backs + type×spatial interactions ────────────
...
XGB_PARAMS = dict(
    ...
    min_child_weight=7,            # was 5 → tighter
...
print("\n" + "=" * 60)
print("THAMAN Riyadh v3 — Training complete")
