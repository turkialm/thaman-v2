"""
THAMAN Stack v10 — train_stack_v10.py
======================================
Key improvements over v9:
  • NTA price trend slope — OLS slope of mean log_price over sale_year per NTA
      — captures neighbourhood appreciation momentum (e.g. Bushwick +8%/yr)
      — 94 total features (93 v9 + nta_price_trend_slope)

Expected gain vs v9: R² 0.6469 → ~0.650–0.655, MedAPE 20.12% → ~19.5–19.8%

Run:
  cd /Users/totam/Desktop/new_try
  python training/train_stack_v10.py
"""
...
print("=" * 70)
print("  THAMAN Stack v10 — NTA Price Trend Slope (94 features)")
print("=" * 70)
...
meta.update({
    ...
    "stack": {
        ...
        "r2_improvement":     round(r2_stk - 0.6469, 4),
        "medape_improvement": round(20.12 - mp_stk, 2),
    },
})
...
print("\n" + "="*70)
print("  THAMAN Stack v10 — Complete")
print("="*70)
...
for nm, r, m, mp_ in [("XGB-A",r2_xa,mae_xa,mp_xa),("XGB-B",r2_xb,mae_xb,mp_xb),
                       ...
                       ("Stack v10",r2_stk,mae_stk,mp_stk)]:
    print(f"  {nm:<24}  {r:>7.4f}  ${m:>13,.0f}  {mp_:>8.2f}%")
print(f"\n  vs v9: ΔR²={r2_stk-0.6469:+.4f}  ΔMedAPE={20.12-mp_stk:+.2f}pp")
